...
#ifndef _SuperHashTokenRPC_H_
#define _SuperHashTokenRPC_H_ 1
...
// SuperHashToken RPC error codes
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // SuperHashToken is not connected
...
/**
 * SuperHashToken RPC command dispatcher.
 */
class CRPCTable
{
private:
